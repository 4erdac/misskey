...
import { OidcAuthService } from './OidcAuthService.js';
...
const $OidcService: Provider = { provide: 'OidcService', useExisting: OidcService };
const $OidcAuthService: Provider = { provide: 'OidcAuthService', useExisting: OidcAuthService };
