	...
	<div :class="[$style.main, $style.panel]">
		...
		<div :class="$style.mainFg">
			...
			<div class="_gaps_s" :class="$style.mainActions">
				<MkButton v-if="instance.oidcRegistrationUrl" :class="$style.mainAction" full rounded gradate primary link :to="instance.oidcRegistrationUrl">{{ i18n.ts.joinThisServer }}</MkButton>
